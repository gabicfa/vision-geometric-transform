...
while(True):
    ...
    # if O
    #     cv2.putText(frame,"ande para traz",(10,30), font, 1,(255,0,0),5,cv2.CV_AA)

    # elif abs(Pz)<abs(Oz) and abs((Pz)-(Oz))< 5:
    #     cv2.putText(frame,"ande para frente", font, 1,(255,0,0),5,cv2.CV_AA)
